...
/**
 * POST /api/friends/cancel  body: { requestId }
 * Cancel a pending friend request. Only the sender (user_id) can cancel.
 */
export async function POST(req) {
    try {
        ...
        console.error('POST /api/friends/cancel:', err);
        return jsonResponse({ error: 'Failed to cancel request' }, 500);
    }
}
